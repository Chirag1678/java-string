// Perform the operation to convert the String characters to lowercase using charAt and toLowerCase methods
import java.util.Scanner;

class ConvertToLowercase {
    // Method to convert the string to lowwercase using charAt method
