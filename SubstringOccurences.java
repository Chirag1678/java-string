// Program to calculate number of times a substring occurs in the String
...
class SubstringOccurences {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Number of times the substring occurs in the string: " + result);
...
// Sample Output ->
// Number of times the substring occurs in the string: 2